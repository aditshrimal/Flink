...
import connectors.HadoopConnector;
...
public class KafkaFlinkHadoop {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            inputJson.addSink(HadoopConnector.getSink("topicName","hdfs://hadoopUrl"))
                    .setParallelism(1)
                    .name("HDFSSink");
             //Adding bucket-sink to sink here for writing files to HDFS

            env.execute("Flink_Hadoop");
